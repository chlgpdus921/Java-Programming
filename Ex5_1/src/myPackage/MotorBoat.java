...
public class MotorBoat {
	...
	public void AmountTravelDistance() {
		System.out.println("For current speeed is " + currentSpeed + " and fuel amount " + fuelAmount
				+ ", travel distance: " + (fuelAmount / (efficiency * currentSpeed)));
	}

	public boolean equals(MotorBoat boat) {
		return ((this.currentSpeed == boat.currentSpeed) && (this.efficiency == boat.efficiency)
				&& (this.maxSpeed == boat.maxSpeed) && (this.fuelAmount == boat.fuelAmount));
	}
}
